...
|------|------|------|
| ① 교재 섭취 | ✅ | |
| ② 진단 | ✅ | ISSUE-001 수정 + 실제 진단 세션(10/10)으로 E2E 확인 완료 |
| ③ 씨앗 | ⚠️ | `concept_mastery`; seed API 스텁 |
...
|------|------|
| documents ingestion | ✅ |
| diagnostic BKT + gated | ✅ ISSUE-001 수정 + E2E 확인 완료 |
| bridge/focused curriculum | ✅ ISSUE-007 수정 완료 |
| auth | ⬜ 스텁 (`dev@local`) |
| seed / review | ⬜ 스텁 |
| 학습 중 적응 루프 | ❌ ISSUE-005 |
| migration 0009 | ✅ (`alembic current` = 0009 head, 이미 적용됨) |
| 대규모 변경 커밋 | ⚠️ ISSUE-002 |
...
1. 학습 중 확인 루프 (ISSUE-005)
2. seed formalize (ISSUE-004)
3. auth
4. 씨앗 기반 “다음 개념” 추천
5. (선택) doc_chunks — 인용 UI 넣을 때만
